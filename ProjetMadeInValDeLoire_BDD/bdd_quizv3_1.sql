...
--
-- Client :  localhost
-- Généré le :  Ven 19 Mai 2023 à 14:49
...
--
ALTER TABLE `quiz`
 ADD PRIMARY KEY (`CLP_quiz`), ADD KEY `difficulte` (`difficulte`);
...
--
ALTER TABLE `score`
MODIFY `CLE_quiz` tinyint(4) NOT NULL AUTO_INCREMENT COMMENT 'ClÃ© quiz',AUTO_INCREMENT=5;
--
